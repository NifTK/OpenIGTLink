...
int main(int argc, char* argv[])
{
  ...
  if (argc != 5) // check number of arguments
    ...
    std::cerr << "    <hostname> : IP or host name, default to localhost"                    << std::endl;
    std::cerr << "    <port>     : Port # (3200 in Slicer default)"   << std::endl;
  ...
  if (r != 0)
	...
	infoMsg->SetString("<ClientDescriptor><Device CommunicationType=\"Porta Interface\" DeviceName=\"Ultrasonix\" PortName=\"\" DeviceType=\"Imager\"/><Client ClientIP=\"UNKNOWN\" ClientPort=\"3200\"/></ClientDescriptor>");
