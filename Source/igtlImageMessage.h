...
protected:
  ...
  /// A flag that indicates is the spacing has been set.
  bool spacingSet;
  
  /// A flag that indicates is the normals have been set.
  bool normalsSet;

  /// A flag that indicates is the origin has been set.
  bool originSet;

  /// A flag that indicates is the matrix has been set.
  bool matrixSet;
