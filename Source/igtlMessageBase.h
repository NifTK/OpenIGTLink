...
public:
  ...
  /// Sets time of message creation. 'sec' and 'nanosec' are seconds and the remaining nanoseconds respectively.
...
protected:
  ...
  /// A time stamp (second) for message creation. It consists of integer fields for seconds
  /// (m_TimeStampSec) and nanoseconds (m_TimeStampNanosec).
